-- ==========================================================
-- SEED COMPLET : 967 SUJETS AUTHENTIQUES EXPRESSION ÉCRITE
-- Source : C:/Users/HP/Desktop/EDUDESK-TCF/967 expression_ecrite_PN_1787291411906/expression_ecrite_banque.json
-- ==========================================================

DELETE FROM public.taches WHERE epreuve = 'expression_ecrite';
...
Vous avez récemment assisté à une fête de quartier entre voisins. Sur votre blog, racontez votre expérience et expliquez pourquoi vous avez aimé cet événement .',
  NULL,
  true
),
(
...
« Je souhaite acheter un vélo en bon état à un prix abordable. Contactez-moi par mail : [email&#160;protected] » 
 Vous possédez un vélo à vendre. Vous rédigez un courriel pour présenter votre vélo et proposer votre prix. Vous fixez aussi un moment pour que l’acheteur puisse le tester .',
  NULL,
  true
),
(
...
« Bonjour, 
 ...
 Vous lui répondez en décrivant cette salle (ambiance, matériel, prix, etc.) .',
  NULL,
  true
),
(
...
« Cher collègue, 
 Nous cherchons un local pour organiser la fête de fin d''année de notre école de musique. Nous cherchons un lieu pour accueillir 100 personnes. Merci de nous faire une proposition. 
 La direction de l''école de musique de Louviers » 
...
Votre ami Thomas vous écrit ce message : 
 « Bonjour ! 
 Je ne suis pas très familier avec la culture et les traditions de ton pays. 
 Peux-tu me présenter une fête importante qui y est célébrée ? 
 À bientôt ! » 
 Rédigez une réponse dans laquelle vous décrivez une grande célébration de votre pays .',
  NULL,
  true
),
(
...
« Bonjour, 
 Tu viens de débuter ton nouveau poste ! 
 Comment trouves-tu ça ? Tu es content(e) ? 
 Ali » 
 Vous écrivez une réponse à votre ami Ali. Vous y décrivez votre poste, l’environnement de travail, les personnes avec qui vous travaillez et vos ressentis .',
  NULL,
  true
),
(
...
INFOS FAMILLES : Accueillir une personne âgée chez soi : comment s’organiser ? 
 Nous souhaitons recueillir des témoignages. Vous avez déjà accueilli une personne âgée chez vous. Vous partagez votre expérience .',
  NULL,
  true
),
(
...
« Salut ! 
 Je suis prêt à veiller sur ta maison et ton jardin pendant tes vacances. 
 Peux-tu me dire exactement ce que je dois faire ? 
 À bientôt, Cédric » 
...
« Bonjour ! 
 J’ai entendu dire que tu pratiques une activité sportive depuis le mois dernier. Ça m’intéresse et j’aimerais t’accompagner. Tu peux me donner plus de détails ? 
 À bientôt ! Camille » 
 Vous écrivez une réponse à votre ami(e) Camille. Dans votre message, vous présentez votre sport et indiquez des détails pratiques (endroit, temps, coût, etc.) .',
  NULL,
  true
),
(
...
Tout recommencer ailleurs ? 
 « Il y a deux ans, nous avons pris la décision de repartir à zéro. Paul a abandonné son travail de banquier à Paris, et nous avons ouvert une boulangerie à Calgary ! Qu’en pensez-vous ? Avez-vous déjà connu un grand changement dans votre vie personnelle ou professionnelle ? Paul et Naïma » 
 Vous avez vu ce message sur un forum. Vous répondez à Paul et Naïma pour donner votre opinion et dire comment vous réagiriez dans une situation pareille .',
  NULL,
  true
),
(
...
«Salut. 
 Merci encore pour ce très bon repas. 
 J''ai adore le plat: Est-ce que tu peux me donner la recette ? 
 A bientot. 
 Nicolas» 
 Vous répondez à votre ami Nicolas. Dans votre message, vous lui expliquez comment vous avez préparé ce plat.',
  NULL,
  true
),
(
...
« VENEZ VISITER NOTRE ÉCOLE DE MUSIQUE ! 
 COURS OFFERTS, CONCERTS ET ACTIVITÉS POUR TOUS. 
 RENDEZ-VOUS CE SAMEDI DÈS 10 HEURES DANS NOTRE ÉTABLISSEMENT ! » 
 Vous avez participé à cette journée. Vous envoyez un message à vos amis pour leur décrire votre expérience et partager votre opinion sur cet événement.',
  NULL,
  true
),
(
...
« Je cherche à acheter un vélo bien entretenu et à un prix raisonnable. 
 Merci de me contacter par courriel à cette adresse : [email&#160;protected] » 
 Vous possédez un vélo à vendre. Rédigez un message à cette personne pour donner la description du vélo, indiquer son prix et fixer une rencontre pour qu’elle puisse le tester.',
  NULL,
  true
),
(
...
« Salut, 
 Tu as commencé ton nouveau boulot ! 
 Comment ça se passe ? Es-tu satisfait(e) ? 
 Ali » 
 Répondez à Ali en lui parlant de votre nouveau poste (lieu, collègues…) et en donnant votre avis.',
  NULL,
  true
),
(
...
INFOS FAMILLES 
 Vivre avec un âgé : comment s’organiser ? 
 Notre site souhaite recueillir des témoignages. Vous avez déjà cohabité avec une personne âgée. Décrivez votre expérience.',
  NULL,
  true
),
(
...
Votre ami Thomas vous a écrit : 
 « Salut, 
 Je ne suis pas très au courant des coutumes de votre pays. 
 Pouvez-vous m’expliquer une fête populaire que vous célébrez ? 
 À bientôt ! » 
...
COURRIER DES LECTEURS 
 Partir un an pour voyager : est-ce conseillé ou risqué ? 
 Partagez votre point de vue sur “voyage.internaute.fr” et appuyez-le avec des exemples personnels.',
  NULL,
  true
),
(
...
Le site www.manger-international.com lance un appel à témoignages. 
 Ce mois-ci, il veut découvrir les habitudes alimentaires dans différents pays. 
 Vous écrivez un article pour parler de celles de votre pays. 
 Dites ce que vous appréciez ou non dans ces habitudes, et expliquez pourquoi .',
  NULL,
  true
),
(
...
France Télévision prépare un reportage sur le sport amateur. 
 Et vous, quel sportif êtes-vous ? Envoyez-nous vos témoignages sur  francetélévision.fr.',
  NULL,
  true
),
(
